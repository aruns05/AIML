...
def lookup(name: str) -> str:
    ...
    template = """
    Given the full name {name_of_person} I want you to get me link to their Linkedin Profile page. {name_of_person} is a architect and works in Cognizant Bengaluru  . Your answer should
    contain only a url
    """
    ...
    tools_for_agent =[
        Tool(
            name="Crawl google 4 linkedin profiles with location Bengaluru",
